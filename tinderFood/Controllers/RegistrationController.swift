...
extension RegistrationController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    // UIImagePickerController - view controller that manages the system interfaces for taking pictures, recording movies, and choosing items from the user's media library
...
class RegistrationController: UIViewController {
    ...
    @objc fileprivate func handleTapDismiss() {
        self.view.endEditing(true) // dismisses keyboard when tap on screen
    }
...
//    }
    ...
    @objc fileprivate func handleKeyboardShow(notification: Notification) {
        ...
        // try to figure out how tall the gap is from the register button to the bottom of the screen is...
    ...
    //UIStackView - streamlined interface for laying out a collection of views in either a column or a row
    ...
    fileprivate func setupGradientLayer() {
        ...
        let bottomColor = #colorLiteral(red: 0.3176470697, green: 0.07450980693, blue: 0.02745098062, alpha: 1)
        
        // make sure to use cgColor - color reference that corresponds to the receiver’s color
